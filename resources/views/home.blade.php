<x-layout>
    ...
    <div class="h-screen p-20 ">
        <div class="fade-in px-4 py-6 sm:px-6 lg:px-8 flex items-center justify-center h-full">
            <div class="text-center  font-light w-3/5 h-full flex items-center flex-col justify-center">
                ...
                <br><br>
                <div class="text-xl px-20 text-justify">Tempe Ayu hadir sebagai produk tempe berkualitas
            ...
            <div class="text-center w-3/5 h-full overflow-hidden">
                <div class="p-4  grid grid-cols-2 gap-4 h-full ">
                    <div class="bg bg-amber-200 flex justify-center flex-col gap-2 rounded-xl shadow-sm ">
                        <div class="text-5xl font-medium">13.8 Gram</div>
    ...
    <div class="h-screen p-20">
        <div class="fade-in px-4 py-6 sm:px-6 lg:px-8 flex items-center justify-center h-full">
            <div class="text-center w-2/5 h-full overflow-hidden">
            ...
            <div class="text-center  font-light w-3/5 h-full flex items-center flex-col justify-center">
                <div class="text-4xl font-bold px-32 text-start w-full ">Keunggulan</div>
                <div class="text-4xl font-bold px-32 text-start w-full ">______________</div>
                <br><br>
                <div class="text-xl font-semibold text-start px-28 w-full">Pilihan Sehat dari Kedelai Pilihan, Tempe Ayu
                </div>
                <div class="text-m px-28 text-justify w-full">Tempe Ayu hadir sebagai produk tempe berkualitas
                    yang terbuat dari kacang kedelai pilihan dan tanpa bahan pengawet atau bahan campuran lainnya, kami
                    berkomitmen untuk menghadirkan tempe murni yang alami dan kaya akan nutrisi bagi masyarakat
                    Indonesia dengan menghasilkan makanan yang tidak hanya lezat, tetapi juga sehat.</div>
                <br><br>
                <div class="text-xl font-semibold text-start px-28 w-full ">Kualitas Terjaga, Cita Rasa
                    Tempe yang Tak Tertandingi</div>
                <div class="text-m px-28 text-justify w-full">Setiap potong Tempe Ayu diproses dengan teliti melalui
